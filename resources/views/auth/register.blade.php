                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="contactNo" type="text" class="form-control{{ $errors->has('contactNo') ? ' is-invalid' : '' }}" name="contactNo" value="{{ old('contactNo') }}" required>
                        ...
                        <div class="form-group row">
                            <label for="oORa" class="col-md-4 col-form-label text-md-right">{{ __('Employee or Admin') }}</label>
